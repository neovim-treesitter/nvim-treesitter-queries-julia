...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-julia/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-julia/actions/workflows/validate.yml)

Neovim tree-sitter queries for **julia**, part of the
...
- [ ] Changes are scoped to `julia` — do not include files for other languages
